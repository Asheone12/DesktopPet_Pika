...
{
    public partial class 动画测试 : Form
    {
        public 动画测试()
        {
            InitializeComponent();
        ...
        private void 动画测试_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void 动画测试_MouseMove(object sender, MouseEventArgs e)
        {
            if (bFormDragging)
            {
        ...
        private void 动画测试_MouseUp(object sender, MouseEventArgs e)
        {
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                bFormDragging = false;
