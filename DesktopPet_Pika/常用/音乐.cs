...
namespace DesktopPet_Pika.常用
{
    public partial class 音乐 : 模板
    {
        ...
        private void axWindowsMediaPlayer1_StatusChange(object sender, EventArgs e)
        {
            ...
            {
                isPlaying = false;
                //播放:pictureBox9.Image = Image.FromFile(AppDomain.CurrentDomain.BaseDirectory + @"Resources\play.png");
                pictureBox9.Image = Properties.Resources.play;
                pictureBox8.Enabled = false;
            }
            if (axWindowsMediaPlayer1.playState.ToString() == "wmppsPlaying")
            {
                isPlaying = true;
                //暂停：pictureBox9.Image = Image.FromFile(AppDomain.CurrentDomain.BaseDirectory + @"Resources\zanting.png");
                pictureBox9.Image = Properties.Resources.zanting;
        ...
        private void pictureBox6_Click(object sender, EventArgs e)
        {
            switch (playMode)
            {
                case 1://循环
                    ...
                    pictureBox6.Image = Properties.Resources.xunhuan_danqu;
                    timer1.Enabled = true;
                    break;
                case 2://单曲
                    playMode = 3;
                    //pictureBox6.Image = Image.FromFile(AppDomain.CurrentDomain.BaseDirectory + @"Resources\suiji.png");
                    pictureBox6.Image = Properties.Resources.xunhuan_suiji;
                ...
                case 3://随机
                    ...
                    pictureBox6.Image = Properties.Resources.xunhuan_liebiao;
